...
# residuals for the model z 
tsdisplay(crash.train$z.r, ci.type = "ma",  main = "")
...
```{r}
#| label: tbl-seacf
#| tbl-cap: "SEACF table of residuals of Time Trend Model"



# Build a highlight matrix
highlight_mat <- eacf_mat == "o" # TODO make thie actually work
