...
fig <- plot_ly(crash, type = 'scatter', mode = 'lines', x = ~DATE, 
      y = ~NUM_CRASHES, name = "Number of Crashes", 
       hovertemplate = paste(
          #"Date: %{x|%Y-%m-%d}",
          "<br>Value: %{y:.2f}",
          "<extra></extra>"
  ...
  layout() %>%
  # Add trend line
  add_lines(x = ~DATE, y = ~trend, name = "Trend", 
            line = list(color = "#2C3E50", dash = "dash")) %>%

  # Add horizontal reference line
  #add_lines(x = '2017-06-30',y = 0, name = "Reference (0)",
  ...
  layout(
    ...
    xaxis = list(
      title = "Date",
      showspikes = TRUE,
      spikemode = "across",     # vertical line across the plot
      spikesnap = "cursor",     # or "data"
      spikethickness = 1,
      spikedash = "solid",
      spikecolor = "grey"
    ),
