...
tsdisplay(residuals(sarima.101), ci.type = "ma", main = "Residuals of SARIMA(1,0,1)(0, 0,1)[7]")
sarima.101.101 <- Arima(crash.train$z, order = c(1, 0, 1), 
                seasonal = list(order = c(1, 0, 1), period = 7), method = "ML", )
tsdisplay(residuals(sarima.101.101), ci.type = "ma", main = "Residuals of SARIMA(1,0,1)(1, 0,1)[7]")
...
aic.sarima <- data.frame(sarima.101 = sarima.101$aic, sarima.101.101$aic, sarima.201.101$aic)
colnames(aic.sarima) <- c("ARIMA(1,0,1)(0,0,1)[7]", "ARIMA(1,0,1)(1,0,1)[7]", "ARIMA(2,0,1)(1,0,1)[7]")
...
## Residual Diagnostic Plots for Time Trend Model with ARMA(0, 1) Residuals (optional)
<details>
<summary>Click to expand</summary>

```{r}
#| label: fig-res-arma01
#| fig-cap: "Residual Diagnostic Plots for Time Trend Model with ARMA(0, 1) Residuals"
#| fig-ncol: 2
#| fig-subcap: 
#|   - "Residual Plots"
#|   - "QQ Plot"
...
::: callout-note
## Residual Diagnostic Plots for Time Trend Model with ARMA(1, 0) Residuals (optional)
<details>
<summary>Click to expand</summary>

```{r}
#| label: fig-res-arma10
#| fig-cap: "Residual Diagnostic Plots for Time Trend Model with ARMA(1, 0) Residuals"
#| fig-ncol: 2
#| fig-subcap: 
#|   - "Residual Plots"
#|   - "QQ Plot"
